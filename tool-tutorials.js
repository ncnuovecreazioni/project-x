...
(function(){
  ...
  var TOOL_FOCUS = {
    ...
    "1password": {area:"Vaults / Condivisione", focus:"centralizzare credenziali e accessi senza condividerli in chiaro", action:"crea un vault di prova e condividi una sola credenziale con il team"},
    "otter": {area:"Meetings / Transcription", focus:"trascrivere una riunione e ottenere un riepilogo utilizzabile", action:"registra una breve riunione di prova e controlla trascrizione e punti chiave"},
    "jotform": {area:"Forms / Workflows", focus:"raccogliere una richiesta e portare i dati nel sistema giusto", action:"crea un modulo di prova e invia una risposta test per verificare il flusso"},
